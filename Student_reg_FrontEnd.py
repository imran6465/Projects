...
def Update():
       ...
       if(len(name.get()) != 0):
          Student_reg_BackEnd.py.insert(name.get(), fname.get(), mname.get(), address.get(), mobno.get(), email.get(), dob.get(), \
                                  gender.get(), eemarks.get(), scmarks.get(), prevsch.get(), firstpref.get(), secpref.get())
...
Main_Frame = LabelFrame(master, width = 1300, height = 700, font = ('arial',20,'bold'), \
                             bg = 'lavender',bd = 5, relief = 'ridge')
Main_Frame.grid(row = 0, column = 0, padx = 10, pady = 20)

Frame_1 = LabelFrame(Main_Frame, width = 1250, height = 620, font = ('arial',15,'bold'), \
                          relief = 'ridge', bd = 0, bg = 'lavender', text = 'STUDENT INFORMATION ')
Frame_1.grid(row = 1, column = 0, padx = 335, pady = 10)
                

Frame_3 = LabelFrame(master, width = 1200, height = 80, font = ('arial',10,'bold'), \
                          bg = 'lavender', relief = 'ridge', bd = 5)
Frame_3.grid(row = 2, column = 0, pady = 10)



#========================================================Labels of Frame_1========================================================
Label_name = Label(Frame_1, text = 'Student\'s name', font = ('arial',14,'bold'),  bg = 'lavender')
Label_name.grid(row = 0, column = 0, sticky = W, padx = 50, pady = 10)
Label_fname = Label(Frame_1, text = 'Father\'s Name', font = ('arial',14,'bold'),  bg = 'lavender')
Label_fname.grid(row = 1, column = 0, sticky = W, padx = 50)
Label_mname = Label(Frame_1, text = 'Mother\'s Name', font = ('arial',14,'bold'),  bg = 'lavender')
Label_mname.grid(row = 2, column = 0, sticky = W, padx = 50)
Label_address = Label(Frame_1, text = 'Address', font = ('arial',14,'bold'),  bg = 'lavender')
Label_address.grid(row = 3, column = 0, sticky = W, padx = 50)
Label_mobno = Label(Frame_1, text = 'Mobile Number', font = ('arial',14,'bold'),  bg = 'lavender')
Label_mobno.grid(row = 4, column = 0, sticky = W, padx = 50)
Label_emailID = Label(Frame_1, text = 'Email ID', font = ('arial',14,'bold'),  bg = 'lavender')
Label_emailID.grid(row = 5, column = 0, sticky = W, padx = 50)
Label_dob = Label(Frame_1, text = 'Date of Birth', font = ('arial',14,'bold'),  bg = 'lavender')
Label_dob.grid(row = 6, column = 0, sticky = W, padx = 50)
Label_gender = Label(Frame_1, text = 'Gender', font = ('arial',14,'bold'),  bg = 'lavender')
Label_gender.grid(row = 7, column = 0, sticky = W, padx = 50, pady = 10)
Label_eemarks = Label(Frame_1, text = 'Entrance Exam Marks', font = ('arial',14,'bold'),  bg = 'lavender')
Label_eemarks.grid(row = 8, column = 0, sticky = W, padx = 50)
Label_scmarks = Label(Frame_1, text = 'Grade 12 Total Marks', font = ('arial',14,'bold'),  bg = 'lavender')
Label_scmarks.grid(row = 9, column = 0, sticky = W, padx = 50)
Label_prevsch = Label(Frame_1, text = 'Previous School', font = ('arial',14,'bold'),  bg = 'lavender')
Label_prevsch.grid(row = 10, column = 0, sticky = W, padx = 50)
Label_firstpref = Label(Frame_1, text = 'First Preferred Stream', font = ('arial',14,'bold'),  bg = 'lavender')
Label_firstpref.grid(row = 11, column = 0, sticky = W, padx = 50)
Label_secpref = Label(Frame_1, text = 'Second Preferred Stream', font = ('arial',14,'bold'),  bg = 'lavender')
