...
Lbl_title = Label(Frame, text = 'PSG College of Engineering', font = ('arial',40,'bold'), bg = 'lavender', fg = 'Black')
Lbl_title.grid(row = 0, column = 0, columnspan =5, pady = 20)
Lbl_name = Label(Frame, text = 'Student Registration', font = ('arial',40,'bold'), bg = 'lavender', fg = 'Black')
Lbl_name.grid(row = 1, column = 0, columnspan =5, pady = 20)

Reg_Frame_1 = LabelFrame(Frame, width = 1350, height = 600, relief = 'ridge', bg = 'lavender', bd = 15, font = ('arial',20,'bold'))
Reg_Frame_1.grid(row = 3, column =0, columnspan =5)
Reg_Frame_2 = LabelFrame(Frame, width = 1000, height = 600, relief = 'ridge',bg = 'lavender', bd = 15, font = ('arial',20,'bold'))
Reg_Frame_2.grid(row = 4, column = 0, columnspan =5)

#USERNAME AND PASSWORD
Label_Username = Label(Reg_Frame_1, text = 'Username', font = ('arial',20,'bold'), bg = 'lavender', bd = 20)
Label_Username.grid(row = 0, column = 0)
text_Username = Entry(Reg_Frame_1, font = ('arial',20,'bold'), textvariable = Username)
text_Username.grid(row = 0, column = 1, padx = 50)                       

Label_Password = Label(Reg_Frame_1, text = 'Password', font = ('arial',20,'bold'), bg = 'lavender', bd = 20)
Label_Password.grid(row = 1, column = 0)
text_Password = Entry(Reg_Frame_1, font = ('arial',20,'bold'), show = '*', textvariable = Password)
text_Password.grid(row = 1, column = 1)

Label_Confirm = Label(Reg_Frame_1, text = 'Confirm Password', font = ('arial',20,'bold'), bg = 'lavender', bd = 20)
