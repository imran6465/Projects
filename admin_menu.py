...
def menu():
       ...
       title_Frame = LabelFrame(root, font = ('arial',50,'bold'), width = 1000, height = 100, bg = 'lavender', relief = 'raise', bd = 13)
       title_Frame.grid(row = 0, column = 0,  pady = 50)

       title_Label = Label(title_Frame, text = 'ADMIN MENU', font = ('arial',30,'bold'), bg = 'lavender')
       title_Label.grid(row = 0, column = 0, padx = 150)


       #FRAMES
       Frame_1 = LabelFrame(root, font = ('arial',17,'bold'), width = 1000, height = 100, bg = 'lavender', relief = 'ridge', bd = 10)
       Frame_1.grid(row = 1, column = 0, padx = 280)
       Frame_2 = LabelFrame(root, font = ('arial',17,'bold'), width = 1000, height = 100, bg = 'lavender', relief = 'ridge', bd = 10)
       Frame_2.grid(row = 2, column = 0, padx = 130, pady = 7)
       Frame_3 = LabelFrame(root, font = ('arial',17,'bold'), width = 1000, height = 100, bg = 'lavender', relief = 'ridge', bd = 10)
       ...
       #LABELS
       Label_1 = Label(Frame_1, text = 'COLLEGE DETAILS', font = ('arial',25,'bold'), bg = 'lavender')
       Label_1.grid(row = 0, column = 0, padx = 50, pady = 5)
       Label_2 = Label(Frame_2, text = 'STUDENT DETAILS', font = ('arial',25,'bold'), bg = 'lavender')
       Label_2.grid(row = 0, column = 0, padx = 100, pady = 5)
       Label_3 = Label(Frame_3, text = 'EDIT CUTOFF VALUES', font = ('arial',25,'bold'), bg = 'lavender')
