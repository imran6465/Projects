...
Main_Frame = LabelFrame(master, width = 1300, height = 500, font = ('arial',20,'bold'), bg = 'lavender blush',bd = 15, relief = 'ridge')
Main_Frame.grid(row = 0, column = 0, padx = 10, pady = 20)

Frame_1 = LabelFrame(Main_Frame, width = 600, height = 400, font = ('arial',15,'bold'), \
                          relief = 'ridge', bd = 10, bg = 'lavender blush', text = 'CUTOFF DETAILS ')
Frame_1.grid(row = 1, column = 0, padx = 10)

Frame_2 = LabelFrame(Main_Frame, width = 750, height = 400, font = ('arial',15,'bold'), \
                          relief = 'ridge', bd = 10, bg = 'lavender blush', text = 'CUTOFF DATABASE')
Frame_2.grid(row = 1, column = 1, padx = 5)                  

Frame_3 = LabelFrame(master, width = 1200, height = 100, font = ('arial',10,'bold'), \
                          bg = 'lavender blush', relief = 'ridge', bd = 13)
Frame_3.grid(row = 2, column = 0, pady = 10)



Label_cutoff1 = Label(Frame_1, text = 'Cutoff for Integrated CSE', font = ('arial',20,'bold'),  bg = 'lavender blush')
Label_cutoff1.grid(row = 0, column = 0, sticky = W, padx = 20, pady = 10)
Label_cutoff2 = Label(Frame_1, text = 'Cutoff for Integrated ECE', font = ('arial',20,'bold'),  bg = 'lavender blush')
Label_cutoff2.grid(row = 1, column = 0, sticky = W, padx = 20)
Label_cutoff3 = Label(Frame_1, text = 'Cutoff for CSE', font = ('arial',20,'bold'),  bg = 'lavender blush')
Label_cutoff3.grid(row = 2, column = 0, sticky = W, padx = 20)
Label_cutoff4 = Label(Frame_1, text = 'Cutoff for ECE', font = ('arial',20,'bold'),  bg = 'lavender blush')
Label_cutoff4.grid(row = 3, column = 0, sticky = W, padx = 20)
Label_cutoff5 = Label(Frame_1, text = 'Cutoff for AE', font = ('arial',20,'bold'),  bg = 'lavender blush')
Label_cutoff5.grid(row = 4, column = 0, sticky = W, padx = 20)
Label_cutoff6 = Label(Frame_1, text = 'Cutoff for MCE', font = ('arial',20,'bold'),  bg = 'lavender blush')
