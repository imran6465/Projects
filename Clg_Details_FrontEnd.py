...
Label_name = Label(Frame_1, text = 'Name', font = ('arial',20,'bold'),  bg = 'lavender')
Label_name.grid(row = 0, column = 0, sticky = W, padx = 20, pady = 10)
Label_cno = Label(Frame_1, text = 'College Number', font = ('arial',20,'bold'),  bg = 'lavender')
Label_cno.grid(row = 1, column = 0, sticky = W, padx = 20)
Label_ano = Label(Frame_1, text = 'Affliation Number', font = ('arial',20,'bold'),  bg = 'lavender')
Label_ano.grid(row = 2, column = 0, sticky = W, padx = 20)
Label_address = Label(Frame_1, text = 'Address', font = ('arial',20,'bold'),  bg = 'lavender')
Label_address.grid(row = 3, column = 0, sticky = W, padx = 20)
Label_mobno = Label(Frame_1, text = 'Mobile Number', font = ('arial',20,'bold'),  bg = 'lavender')
Label_mobno.grid(row = 4, column = 0, sticky = W, padx = 20)
Label_emailID = Label(Frame_1, text = 'Email ID', font = ('arial',20,'bold'),  bg = 'lavender')
Label_emailID.grid(row = 5, column = 0, sticky = W, padx = 20)
Label_det = Label(Frame_1, text = 'Details', font = ('arial',20,'bold'),  bg = 'lavender')
