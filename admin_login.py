...
def login():
    ...
    if (un == str('admin') and pw == str(12345)):
        adminmenu()
    else:
...
Lbl_name = Label(frame, text = 'College Admission System - Admin', font = ('arial',40,'bold'), bg = 'lavender', fg = 'Black')
Lbl_name.grid(row = 1, column = 0, columnspan =5, pady = 20)

Login_Frame_1 = LabelFrame(frame, width = 1350, height = 600, relief = 'ridge', bg = 'lavender', bd = 15, font = ('arial',20,'bold'))
Login_Frame_1.grid(row = 3, column =0, columnspan =5)
Login_Frame_2 = LabelFrame(frame, width = 1000, height = 600, relief = 'ridge',bg = 'lavender', bd = 15, font = ('arial',20,'bold'))
Login_Frame_2.grid(row = 4, column = 0, columnspan =5)


#LABEL AND ENTRIES
Label_Username = Label(Login_Frame_1, text = 'Admin Username', font = ('arial',20,'bold'), bg = 'lavender', bd = 20)
Label_Username.grid(row = 0, column = 0)
text_Username = Entry(Login_Frame_1, font = ('arial',20,'bold'), textvariable = user)
text_Username.grid(row = 0, column = 1, padx = 50)                       

Label_Password = Label(Login_Frame_1, text = 'Password', font = ('arial',20,'bold'), bg = 'lavender', bd = 20)
