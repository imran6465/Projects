...
Main_Frame = LabelFrame(master, width = 1300, height = 700, font = ('Helvetica',25,'bold'), \
                            bg = 'lavender blush',bd = 5, relief = 'ridge')
Main_Frame.grid(row = 0, column = 0, padx = 10, pady = 20)

Frame_1 = LabelFrame(Main_Frame, width = 750, height = 620, font = ('Helvetica',20,'bold'), \
                         relief = 'ridge', bd = 5, bg = 'lavender blush', text = 'STUDENT INFORMATION ')
Frame_1.grid(row = 1, column = 0, padx = 15, pady = 30)

Frame_2 = LabelFrame(Main_Frame, width = 750, height = 620, font = ('Helvetica',20,'bold'), \
                         relief = 'ridge', bd = 5, bg = 'lavender blush', text = 'STUDENT DATABASE')
Frame_2.grid(row = 1, column = 1, padx = 15, pady = 30)                  

Frame_3 = LabelFrame(master, width = 1200, height = 80, font = ('Helvetica',10,'bold'), \
                         bg = 'lavender blush', relief = 'ridge', bd = 5)
Frame_3.grid(row = 2, column = 0, pady = 10)



#Labels of Frame_1
Label_name = Label(Frame_1, text = 'Student\'s name', font = ('arial',14,'bold'), bg = 'lavender blush')
Label_name.grid(row = 0, column = 0, sticky = W, padx = 20, pady = 10)
Label_fname = Label(Frame_1, text = 'Father\'s Name', font = ('arial',14,'bold'), bg = 'lavender blush')
Label_fname.grid(row = 1, column = 0, sticky = W, padx = 20)
Label_mname = Label(Frame_1, text = 'Mother\'s Name', font = ('arial',14,'bold'), bg = 'lavender blush')
Label_mname.grid(row = 2, column = 0, sticky = W, padx = 20)
Label_address = Label(Frame_1, text = 'Address', font = ('arial',14,'bold'),  bg = 'lavender blush')
Label_address.grid(row = 3, column = 0, sticky = W, padx = 20)
Label_mobno = Label(Frame_1, text = 'Mobile Number', font = ('arial',14,'bold'),  bg = 'lavender blush')
Label_mobno.grid(row = 4, column = 0, sticky = W, padx = 20)
Label_emailID = Label(Frame_1, text = 'Email ID', font = ('arial',14,'bold'),  bg = 'lavender blush')
Label_emailID.grid(row = 5, column = 0, sticky = W, padx = 20)
Label_dob = Label(Frame_1, text = 'Date of Birth', font = ('arial',14,'bold'),  bg = 'lavender blush')
Label_dob.grid(row = 6, column = 0, sticky = W, padx = 20)
Label_gender = Label(Frame_1, text = 'Gender', font = ('arial',14,'bold'),  bg = 'lavender blush')
Label_gender.grid(row = 7, column = 0, sticky = W, padx = 20, pady = 10)
Label_eemarks = Label(Frame_1, text = 'Entrance Exam Marks', font = ('arial',14,'bold'),  bg = 'lavender blush')
Label_eemarks.grid(row = 8, column = 0, sticky = W, padx = 20)
Label_scmarks = Label(Frame_1, text = 'Grade 12 Total Marks', font = ('arial',14,'bold'),  bg = 'lavender blush')
Label_scmarks.grid(row = 9, column = 0, sticky = W, padx = 20)
Label_prevsch = Label(Frame_1, text = 'Previous School', font = ('arial',14,'bold'),  bg = 'lavender blush')
Label_prevsch.grid(row = 10, column = 0, sticky = W, padx = 20)
Label_firstpref = Label(Frame_1, text = 'First Preferred Stream', font = ('arial',14,'bold'),  bg = 'lavender blush')
Label_firstpref.grid(row = 11, column = 0, sticky = W, padx = 20)
Label_secpref = Label(Frame_1, text = 'Second Preferred Stream', font = ('arial',14,'bold'),  bg = 'lavender blush')
